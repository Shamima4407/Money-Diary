...
public class Login implements ActionListener,MouseListener{
    ...
    public Login(){
        ...
        acountCreateMessegeLb = new JLabel("Don't an have acount?");
        ...
        createNewOneLb.setBounds(340,300,150,20);
        //setBounds for Creating new messege;
        acountCreateMessegeLb.setBounds(200,300,130,20);
